...
public class ExerciseListAdapter extends RecyclerView.Adapter<ExerciseListAdapter.VHCategory> implements ItemTouchHelperAdapter{
    ...
    private List<PlanDays> daysList = new ArrayList<>();
    ...
    public void onBindViewHolder(final VHCategory holder, int position) {
        PlanDays category = daysList.get(position);

        holder.holderIV.setOnTouchListener(new View.OnTouchListener() {
            @Override
    ...
    public void setExerciseList(List<PlanDays> categories) {
        daysList = categories;
