...
public class AppConstant {
    ...
    public static final String WORKOUT_JSON_PATH = "workout_json/all_final_json.json";
    public static final String WORKOUT_CUSTOM_JSON_PATH = "workout_json/custom_json.json";
    ...
    public static final String EASY_PLAN_KEY = "workout_easy_plan";
    public static final String MEDIUM_PLAN_KEY = "workout_medium_plan";
    public static final String HARD_PLAN_KEY = "workout_hard_plan";
    public static final String CUSTOM_PLAN_KEY = "workout_custom_plan";
